...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    PlayerUpgradeManager m_PlayerUpgradeManager;
    ...
    // collision overrides so that playercharactercontroller collision works w/ pickups and selectables (like chests n stuff). further support for selectables is in update method of playerweaponsmanager
    void OnTriggerEnter(Collider other)
    {
        Pickup pickup = other.gameObject.GetComponentInParent<Pickup>();
        Selectable selectable = other.gameObject.GetComponentInParent<Selectable>();

        if(pickup)
        {
            pickup.OnPick.Invoke(GetComponent<PlayerUpgradeManager>());
        }
        else if(selectable)
        {
            selectable.playerInSelectionRadius = true;
        }
    }
    ...
    void OnTriggerExit(Collider other)
    {
        ...
        if(selectable)
        {
            selectable.playerInSelectionRadius = false;
        }
    }
}
